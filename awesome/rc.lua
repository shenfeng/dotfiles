...
my_tags = awful.screen.focused().tags
...
--    awful.key({ modkey, "Control" }, "k", function () awful.screen.focus_relative(-1) end,
 --             {description = "focus the previous screen", group = "screen"}),
    ...
    awful.key({ modkey, }, "w", function() 
                ...
                awful.tag.viewonly(my_tags[5])
            end,
              {description = "start chrome", group = "app"}),
    ...
    awful.key({ modkey, }, "`", function() 
              ...
              {description = "Run or switch to idea", group = "app"}),

   awful.key({ modkey,       }, "e", function ()
                run_or_raise(emacs, { instance = emacs })
                awful.tag.viewonly(my_tags[7])
            end,
              {description = "Run or switch to emacs", group = "app"}),
